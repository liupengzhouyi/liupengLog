 ...
 *
 * @author liupeng
 * @since 2021-04-14 13:09:34
 */
@ApiModel(value = "LiupengImg")
public class LiupengImg implements Serializable {
    private static final long serialVersionUID = 267486994290999402L;
    /**
     * 自增ID
     */
    ...
    public void setImgAbstract(String imgAbstract) {
        this.imgAbstract = imgAbstract;
    }
